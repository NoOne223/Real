...
const Jacket = () => {
  return (
    <div>
      <div id='Jacket' className='container'>
          <h4 className='text-6xl font-pata'>Jacket</h4>
          <div className='mt-10 grid'>
            <div className='product-area relative'>
              <img src={Blank_img}></img>
              <div className='p-4 flex flex-col gap-y-4'>
                <div className='h-14 text-center'>
                  <h4 className='text-2xl uppercase font-bold'>Jacket 1</h4>
                </div>
            ...
            <div id='New' className='product-area relative'>
              ...
              <div className='p-4 flex flex-col gap-y-4'>
                <div className='text-center h-14'>
                  <h4 className='text-2xl uppercase font-bold'>Jacket 2</h4>
                  <p>
            ...
            <div id='Onsale' className='product-area relative'>
              ...
              <div className='p-4 flex flex-col gap-y-4'>
                <div className='h-14 text-center'>
                  <h4 className='text-2xl uppercase font-bold'>Jacket 3</h4>
                </div>
            ...
            <div id='Outsold' className='product-area relative'>
              ...
              <div className='p-4 flex flex-col gap-y-4'>
                <div className='h-14 text-center'>
                  <h4 className='text-2xl uppercase font-bold'>Jacket 4</h4>
                </div>
